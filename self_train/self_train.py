...
if __name__ == '__main__':
	...
	print 'poscap config', poscap_config
	...
	stmt_extraction_net.load_state_dict(torch.load(in_model_name))
	print "loading done."
	...
	for index in range(5):
		...
		print "loading model parameters..."
		stmt_extraction_net.load_state_dict(torch.load(out_model_name))
		print "loading done."
